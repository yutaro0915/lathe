...
**Phase 1（機能1: 観測 = トランスクリプト / Git 差分 / 統計ビューア）実装済み・E2E 49/49 GREEN**（2026-06-10）。
...
- Phase 2 以降は未着手。スタックは Next.js 15 + Postgres（dev は `docker-compose.dev.yml` の依存コンテナ、アプリは host 実行）。
